...
(function($) {
    ...
    function _previewNavigations() {
        ...
        css += '@media only screen and (min-width: 783px){';
            ...
            if (wp.customize.value('responsi_enable_container_nav_bg_image')() == 'true') {
                ...
                if (wp.customize.value('responsi_hext_n_container_background_image_size_on')() == 'true') {
                    css += 'background-size:' + wp.customize.value('responsi_hext_n_container_background_image_size_width')() + ' ' + wp.customize.value('responsi_hext_n_container_background_image_size_height')() + ';';
                } else {
            ...
            css += '.navigation-in{';
                css += _cFn.renderBG('responsi_hext_n_content_background_color');
                var responsi_hext_n_content_background_image_position_horizontal = 'center';
                if (wp.customize.value('responsi_hext_n_content_background_image_position_horizontal')() != '') {
                    responsi_hext_n_content_background_image_position_horizontal = wp.customize.value('responsi_hext_n_content_background_image_position_horizontal')();
                }
                var responsi_hext_n_content_background_image_position_vertical = 'center';
                if (wp.customize.value('responsi_hext_n_content_background_image_position_vertical')() != '') {
                    responsi_hext_n_content_background_image_position_vertical = wp.customize.value('responsi_hext_n_content_background_image_position_vertical')();
                }

                if (wp.customize.value('responsi_hext_n_content_background_image')() == 'true') {
                    css += 'background-image:url(' + wp.customize.value('responsi_hext_n_content_background_image_url')() + ');';
                    css += 'background-repeat:' + wp.customize.value('responsi_hext_n_content_background_image_repeat')() + ';';
                    css += 'background-position:' + responsi_hext_n_content_background_image_position_horizontal + ' ' + responsi_hext_n_content_background_image_position_vertical + ';';
                } else {
                    css += 'background-image:none !important;';
                }

                if (wp.customize.value('responsi_hext_n_content_background_image_size_on')() == 'true') {
                    css += 'background-size:' + wp.customize.value('responsi_hext_n_content_background_image_size_width')() + ' ' + wp.customize.value('responsi_hext_n_content_background_image_size_height')() + ';';
                } else {
                    css += 'background-size:initial;';
                }

                css += _cFn.renderMarPad('responsi_hext_n_content_padding', 'padding');
                css += _cFn.renderMarPad('responsi_hext_n_content_margin', 'margin');
                css += _cFn.renderRadius('responsi_hext_n_content_border_radius', '');
                css += _cFn.renderBorder('responsi_hext_n_content_border_top', 'top');
                css += _cFn.renderBorder('responsi_hext_n_content_border_bottom', 'bottom');
                css += _cFn.renderBorder('responsi_hext_n_content_border_lr', 'left');
                css += _cFn.renderBorder('responsi_hext_n_content_border_lr', 'right');
                css += _cFn.renderShadow('responsi_hext_n_content_box_shadow');
            css += '}';
            ...
            css += '.navigation-in ul.menu > li{';
                css += _cFn.renderMarPad('responsi_hext_navi_li_margin', 'margin', true);
            ...
            responsi_hext_navbar_border_currentitem = wp.customize.value('responsi_hext_navbar_border_currentitem')(),
            responsi_hext_navbar_border_hover = wp.customize.value('responsi_hext_navbar_border_hover')();
            ...
            css += '.navigation-in ul.menu > li:first-child > a, .customize-partial-edit-shortcuts-shown .navigation-in ul.menu > li:nth-child(2) a{';
                css += _cFn.renderRadius('responsi_hext_navi_border_radius_first_tl', 'top-left');
                css += _cFn.renderRadius('responsi_hext_navi_border_radius_first_tr', 'top-right');
                css += _cFn.renderRadius('responsi_hext_navi_border_radius_first_bl', 'bottom-left');
                css += _cFn.renderRadius('responsi_hext_navi_border_radius_first_br', 'bottom-right');
            css += '}';

            css += '.navigation-in ul.menu > li:last-child > a{';
                css += _cFn.renderRadius('responsi_hext_navi_border_radius_last_tl', 'top-left');
                css += _cFn.renderRadius('responsi_hext_navi_border_radius_last_tr', 'top-right');
                css += _cFn.renderRadius('responsi_hext_navi_border_radius_last_bl', 'bottom-left');
                css += _cFn.renderRadius('responsi_hext_navi_border_radius_last_br', 'bottom-right');
            css += '}';
            ...
            css += '.navigation-in ul.menu > li.current-menu-item > a{' + _cFn.renderBG('responsi_nav_currentitem_bg', true) + 'color:' + responsi_nav_currentitem + ' !important;border-color:'+responsi_hext_navbar_border_currentitem+';}';
            css += '.navigation-in ul.menu > li > a:hover,.navigation-in ul.menu > li:hover > a,.navigation-in .menu > li.menu-item-has-children:hover > a,.navigation-mobile .hamburger-icon:hover,.navigation-mobile .responsi-icon-cancel:hover,.navigation-in ul.menu > li.current-menu-item > a:hover{color:' + responsi_nav_hover + ' !important;border-color:'+responsi_hext_navbar_border_hover+';}';
        ...
        css += '@media only screen and (max-width: 782px){';
            ...
            css += '.navigation-mobile {';
                css += _cFn.renderBG('responsi_hext_navbar_container_mobile_background_color', true);
                css += _cFn.renderMarPad('responsi_hext_navbar_container_mobile_padding', 'padding', true);
                css += _cFn.renderMarPad('responsi_hext_navbar_container_mobile_margin', 'margin', true);
                css += _cFn.renderRadius('responsi_hext_navbar_container_mobile_border_radius', '', true);
                css += _cFn.renderBorder('responsi_hext_navbar_container_mobile_border_top', 'top', true);
                css += _cFn.renderBorder('responsi_hext_navbar_container_mobile_border_bottom', 'bottom', true);
                css += _cFn.renderBorder('responsi_hext_navbar_container_mobile_border_lr', 'left', true);
                css += _cFn.renderBorder('responsi_hext_navbar_container_mobile_border_lr', 'right', true);
                css += _cFn.renderShadow('responsi_hext_navbar_container_mobile_box_shadow', true);
                css += 'text-align:' + wp.customize.value('responsi_hext_navbar_icon_mobile_alignment')() + ' !important;';
            css += '}';
            ...
            css += '.navigation-mobile .hamburger-icon:before, .navigation-mobile svg.hext-icon, .navigation-mobile svg {';
                css += _cFn.renderBG('responsi_hext_navbar_icon_mobile_background_color', true);
                css += _cFn.renderMarPad('responsi_hext_navbar_icon_mobile_padding', 'padding', true);
                css += _cFn.renderMarPad('responsi_hext_navbar_icon_mobile_margin', 'margin', true);
                css += _cFn.renderRadius('responsi_hext_navbar_icon_mobile_border_radius', '', true);
                css += _cFn.renderBorder('responsi_hext_navbar_icon_mobile_border_top', 'top', true);
                css += _cFn.renderBorder('responsi_hext_navbar_icon_mobile_border_bottom', 'bottom', true);
                css += _cFn.renderBorder('responsi_hext_navbar_icon_mobile_border_left', 'left', true);
                css += _cFn.renderBorder('responsi_hext_navbar_icon_mobile_border_right', 'right', true);
                css += _cFn.renderShadow('responsi_hext_navbar_icon_mobile_box_shadow', true);
            css += '}';

            var _iconSeparatorPos = 'right';

            if (wp.customize.value('responsi_hext_navbar_icon_mobile_alignment')() == 'left') {
            ...
            css += '.navigation-mobile span.nav-separator {';
                css += _cFn.renderBorder('responsi_hext_navbar_icon_mobile_separator', _iconSeparatorPos);
            css += '}';

            css += '.navigation-mobile .hamburger-icon:before, .navigation-mobile svg.hext-icon, .navigation-mobile svg{';
                css += 'font-size: ' + wp.customize.value('responsi_hext_navbar_icon_mobile_size')() + 'px !important;';
                css += 'color: ' + wp.customize.value('responsi_hext_navbar_icon_mobile_color')() + ' !important;';
            css += '}';

            if (wp.customize.value('responsi_hext_navbar_mobile_text_on')() == 'false') {
                $('.navigation-mobile .menu-text').html('');
            } else {
                $('.navigation-mobile .menu-text').html(wp.customize.value('responsi_hext_navbar_mobile_text')());
            }

            /* Nav Bar Mobile Text Style */
            css += '.navigation-mobile span.menu-text{';
                css += _cFn.renderMarPad('responsi_hext_navbar_mobile_text_padding', 'padding', true);
                css += _cFn.renderMarPad('responsi_hext_navbar_mobile_text_margin', 'margin', true);
                css += _cFn.renderTypo('responsi_hext_navbar_mobile_text_font', true);
                css += 'text-transform:' + wp.customize.value('responsi_hext_navbar_mobile_text_font_transform')() + ' !important;';
            css += '}';

            css += 'ul.responsi-menu{';
                css += _cFn.renderBG('responsi_hext_navbar_container_dropdown_mobile_background_color');
                css += _cFn.renderMarPad('responsi_hext_navbar_container_dropdown_mobile_margin', 'margin');
                css += _cFn.renderMarPad('responsi_hext_navbar_container_dropdown_mobile_padding', 'padding');
                css += _cFn.renderBorder('responsi_hext_navbar_container_dropdown_mobile_border_top', 'top');
                css += _cFn.renderBorder('responsi_hext_navbar_container_dropdown_mobile_border_bottom', 'bottom');
                css += _cFn.renderBorder('responsi_hext_navbar_container_dropdown_mobile_border_lr', 'left');
                css += _cFn.renderBorder('responsi_hext_navbar_container_dropdown_mobile_border_lr', 'right');
                css += _cFn.renderRadius('responsi_hext_navbar_container_dropdown_mobile_border_radius');
                css += _cFn.renderShadow('responsi_hext_navbar_container_dropdown_mobile_box_shadow');
            css += '}';

            css += 'ul.responsi-menu a{';
                css += _cFn.renderMarPad('responsi_hext_navbar_item_dropdown_mobile_padding', 'padding');
                css += _cFn.renderTypo('responsi_hext_navbar_item_dropdown_mobile_font');
                css += 'text-transform:'+ wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_font_transform')() +';';
                css += _cFn.renderBG('responsi_hext_navbar_item_dropdown_mobile_background');
                css += _cFn.renderBorder('responsi_hext_navbar_item_dropdown_mobile_separator', 'top');
            css += '}';

            css += 'ul.responsi-menu li a:hover, ul.responsi-menu li:hover > a{'; 
                css += _cFn.renderBG('responsi_hext_navbar_item_dropdown_mobile_hover_background');
                css += 'color:'+ wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_hover_color')() +' !important;';    
            css += '}';

            css += 'ul.responsi-menu .menu-item-has-children > i,ul.responsi-menu .menu-item-has-children > svg{';
                css += 'font-size: ' + wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_font[size]')() + 'px;';
                css += 'color: ' + wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_font[color]')() + ';';
                css += 'font-weight: ' + wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_font[style]')() + ';';
            css += '}';

            css += 'ul.responsi-menu ul li a { padding-left: ' + (parseInt(wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_padding_left')()) + 20) + 'px !important; }';
            css += 'ul.responsi-menu ul li ul li a { padding-left: ' + (parseInt(wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_padding_left')()) + 40) + 'px !important; }';
            css += 'ul.responsi-menu ul li ul li ul li a { padding-left: ' + (parseInt(wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_padding_left')()) + 60) + 'px !important; }';
            css += 'ul.responsi-menu ul li ul li ul li ul li a { padding-left: ' + (parseInt(wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_padding_left')()) + 80) + 'px !important; }';
            
            css += 'ul.responsi-menu .sub-menu a{';
                css += _cFn.renderTypo('responsi_hext_navbar_item_dropdown_mobile_submenu_font');
                css += _cFn.renderBorder('responsi_hext_navbar_item_dropdown_mobile_submenu_separator', 'top');
                css += _cFn.renderBG('responsi_hext_navbar_item_dropdown_mobile_submenu_background');
                css += 'text-transform:' + wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_submenu_font_transform')() + ';';
            css += '}';

            css += 'ul.responsi-menu .sub-menu li a:hover, ul.responsi-menu .sub-menu li:hover > a{';
                css += _cFn.renderBG('responsi_hext_navbar_item_dropdown_mobile_submenu_hover_background');
                css += 'color:' + wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_submenu_hover_color')() + ' !important;';
            css += '}';

            css += 'ul.responsi-menu ul.sub-menu .menu-item-has-children > i,ul.responsi-menu ul.sub-menu .menu-item-has-children > svg{';
                css += 'font-size: ' + wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_submenu_font[size]')() + 'px;';
                css += 'color: ' + wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_submenu_font[color]')() + ';';
                css += 'font-weight: ' + wp.customize.value('responsi_hext_navbar_item_dropdown_mobile_submenu_font[style]')() + ';';
            css += '}';

            css += '.responsi-navigation, .hext-moblie-menu-icon{';
            css += _cFn.renderMarPad('responsi_hext_n_container_mobile_padding', 'padding');
            css += _cFn.renderMarPad('responsi_hext_n_container_mobile_margin', 'margin');
            css += '}';

            css += '.navigation-in{';
            css += _cFn.renderMarPad('responsi_hext_n_content_mobile_padding', 'padding');
            css += _cFn.renderMarPad('responsi_hext_n_content_mobile_margin', 'margin');
            css += '}';
    ...
    var single_fields = [
        ...
        'responsi_hext_n_container_background_image_size_on',
        ...
        'responsi_hext_navbar_item_dropdown_mobile_font_transform',
        'responsi_hext_navbar_item_dropdown_mobile_hover_color',
        'responsi_hext_navbar_item_dropdown_mobile_submenu_font_transform',
        'responsi_hext_navbar_item_dropdown_mobile_submenu_hover_color',
        'responsi_hext_navbar_icon_mobile_alignment',
        'responsi_hext_navbar_icon_mobile_size',
        'responsi_hext_navbar_icon_mobile_color',
        'responsi_hext_navbar_mobile_text_on',
        'responsi_hext_navbar_mobile_text',
        'responsi_hext_navbar_mobile_text_font_transform',
        'responsi_hext_n_content_background_image',
        'responsi_hext_n_content_background_image_url',
        'responsi_hext_n_content_background_image_repeat',
        'responsi_hext_n_content_background_image_position_horizontal',
        'responsi_hext_n_content_background_image_position_vertical',
        'responsi_hext_n_content_background_image_size_on',
        'responsi_hext_navbar_border_currentitem',
        'responsi_hext_navbar_border_hover'
    ];
    ...
    var bg_sizes = [
        'responsi_hext_n_container_background_image_size',
        'responsi_hext_n_content_background_image_size',
    ];
    ...
    var margin_padding_fields = [
        ...
        'responsi_hext_navbar_container_dropdown_mobile_margin',
        'responsi_hext_navbar_container_dropdown_mobile_padding',
        'responsi_hext_navbar_item_dropdown_mobile_padding',
        'responsi_hext_navbar_container_mobile_padding',
        'responsi_hext_navbar_container_mobile_margin',
        'responsi_hext_navbar_icon_mobile_padding',
        'responsi_hext_navbar_icon_mobile_margin',
        'responsi_hext_navbar_mobile_text_padding',
        'responsi_hext_navbar_mobile_text_margin',
        'responsi_hext_n_container_mobile_padding',
        'responsi_hext_n_container_mobile_margin',
        'responsi_hext_n_content_padding',
        'responsi_hext_n_content_margin',
        'responsi_hext_n_content_mobile_padding',
        'responsi_hext_n_content_mobile_margin',
        'responsi_hext_navi_li_margin'
    ];
