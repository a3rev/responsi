...
( function( $ ) {
	function responsi_preview_blogs(){
        ...
        css += '.box-item .entry-item.blog-post-item,.responsi-content-main .box-item .entry-item.blog-post-item,.responsi-content-main .box-item .entry-item{'+responsiCustomize.build_background('responsi_blog_box_bg',true)+responsiCustomize.build_border_boxes('responsi_blog_box_border',true)+responsiCustomize.build_box_shadow('responsi_blog_box_shadow',true)+'}';

        css += '.responsi-content-main .box-item .entry-item.blog-post-item .thumbnail{'+responsiCustomize.build_background('responsi_blog_post_thumbnail_bg',true)+responsiCustomize.build_padding_margin('responsi_blog_post_thumbnail_margin','margin',true)+responsiCustomize.build_padding_margin('responsi_blog_post_thumbnail_padding','padding',true)+responsiCustomize.build_border_boxes('responsi_blog_post_thumbnail_border',true)+responsiCustomize.build_box_shadow('responsi_blog_post_thumbnail_shadow',true)+'}';
        ...
        css += '.responsi-content-main .box-item .entry-item.blog-post-item h3{'+responsiCustomize.build_padding_margin('responsi_blog_post_title_padding','padding',true)+'}';
        css += 'body.category .responsi-content-main .box-item .entry-item h3 a,body.tag .responsi-content-main .box-item .entry-item h3 a,body.page-template-template-blog-php .responsi-content-main .box-item .entry-item h3 a, .box-item .entry-item h3 a, body.category .responsi-content-main .box-item .entry-item h3,body.tag .responsi-content-main .box-item .entry-item h3,body.page-template-template-blog-php .responsi-content-main .box-item .entry-item h3, .box-item .entry-item h3,body .responsi-content-main .blog-post .blog-post-item h3 a:link,.responsi-content-main .blog-post.box-item .entry-item h3 a:link, .responsi-content-main .blog-post.box-item .entry-item h3 a:visited{text-transform: '+responsi_blog_post_font_title_transform+' !important;text-align: '+responsi_blog_post_title_alignment+' !important;'+responsiCustomize.build_typography('responsi_blog_post_font_title',true)+'}';
        ...
        css += 'body .responsi-content-main .box-item .entry-item.blog-post-item .entry-bottom .postinfo,.responsi-content-main .box-item .entry-item .entry-bottom .postinfo,body .responsi-content-main .box-item .entry-item.blog-post-item .entry-bottom .posttags,.responsi-content-main .box-item .entry-item .entry-bottom .posttags, body .room_grid_view .box-item .entry-item .room-bottom .view_rom_container,body .room_grid_view .box-item .entry-item .room-bottom .view_room_container,.responsi-content-main .box-item .entry-item .entry-bottom .postinfo, body .room_grid_view .box-item .entry-item .room-bottom .postedin,body .project_grid_view .box-item .entry-item #container_projects .project-bottom .postedin,body #container_projects .view_project_container,body #container_projects .view_project_container,body .sponsor_grid_view .box-item .entry-item #container_sponsor .sponsor-bottom .postedin,body #container_sponsor .postedin,body .people_grid_view .box-item .entry-item #container_people .people-bottom .postedin,body #container_people .postedin,body .responsi-content-content .responsi-content-main .box-item .entry-item .view_people_container{'+responsiCustomize.build_background('responsi_post_author_archive_bg',true)+'}';
        ...
        css += 'body.category .responsi-content-main .box-item .entry-item .entry-bottom,body.tag .responsi-content-main .box-item .entry-item .entry-bottom,body.page-template-template-blog-php .responsi-content-main .box-item .entry-item .entry-bottom, .box-item .entry-item .entry-bottom,.box-item .room-bottom, .box-item .project-bottom, .box-item .people-bottom, .box-item .sponsor-bottom{text-align:' +responsi_blog_ext_alignment+ ';' +responsiCustomize.build_typography('responsi_blog_ext_font',true)+'}';
        css += '.responsi-content-main .box-item .entry-item.blog-post-item .entry-bottom .postinfo,.responsi-content-main .box-item .entry-item.blog-post-item .entry-bottom .posttags,.responsi-content-main .box-item .entry-item .entry-bottom .posttags, body .room_grid_view .box-item .entry-item .room-bottom .view_rom_container, body .room_grid_view .box-item .entry-item .room-bottom .view_room_container,.responsi-content-main .box-item .entry-item .entry-bottom .postinfo, body .room_grid_view .box-item .entry-item .room-bottom .postedin,body .project_grid_view .box-item .entry-item #container_projects .project-bottom .postedin,body #container_projects .view_project_container,body #container_projects .view_project_container,body .sponsor_grid_view .box-item .entry-item #container_sponsor .sponsor-bottom .postedin,body #container_sponsor .postedin,body .people_grid_view .box-item .entry-item #container_people .people-bottom .postedin,body #container_people .view_people_container{'+responsiCustomize.build_padding_margin('responsi_blogext_padding','padding',true)+responsiCustomize.build_border('responsi_post_author_archive_border_top','top',true)+responsiCustomize.build_border('responsi_post_author_archive_border_bottom','bottom',true)+'margin :0px !important;}';
        css += 'body .responsi-content-main .box-item .entry-item.blog-post-item .entry-bottom .posttags,.responsi-content-main .box-item .entry-item .entry-bottom .posttags, div.box-content .box-item div.entry-item .entry-bottom .posttags{'+responsiCustomize.build_border('responsi_post_tags_comment_border_top','top',true)+responsiCustomize.build_border('responsi_post_tags_comment_border_bottom','bottom',true)+'}';
        ...
        css += 'div.box-content .box-item div.entry-item .entry-content a.more-link,body .responsi-content-wrapper .responsi-content-content div.box-content .box-item div.entry-item .entry-content a.button{';
        ...
        if (enable_fix_tall_title_grid == '1') {
            ...
            css += 'body .responsi-content-main .box-item .entry-item h3 a{display:block !important;height: '+blog_title_height+'em !important;overflow: hidden !important;line-height:'+parseFloat(blog_title_line_height)+'em !important;}';
        }
        ...
        if (enable_fix_tall_title_grid == 'none') {
            css += 'body .responsi-content-main .box-item .entry-item h3 a{display:inherit !important;height: inherit !important;overflow: inherit !important;line-height:'+parseFloat(blog_title_line_height)+'em !important;}';
        }
        css += '}';
        ...
        if (enable_fix_tall_des_grid == '1') {
            ...
            css += 'body .responsi-content-main .box-item .entry-item p.gird_descriptions{display:block !important;height: '+blog_des_height+'em !important;overflow: hidden !important;line-height:'+blog_des_line_height+'em !important;}';
        }
        ...
        if (responsi_enable_fix_ext_cat_author == '1') {
            ...
            css += 'body .responsi-content-main .box-item .entry-item .entry-bottom .postinfo .custom_lines{display:block !important;height: '+blog_ext_height+'em !important;overflow: hidden !important;line-height:'+blog_ext_line_height+'em !important;}';
        }
        ...
        if (responsi_enable_fix_ext_cat_author == 'none') {
            css += 'body .responsi-content-main .box-item .entry-item .entry-bottom .postinfo .custom_lines{display:inherit !important;height: auto !important;overflow: hidden !important;line-height:'+blog_ext_line_height+'em !important;}';
        }

        if (responsi_enable_fix_ext_tags_comment == '1') {
            blog_ext_height = parseFloat(blog_ext_line_height) ;
            css += 'body .responsi-content-main .box-item .entry-item .entry-bottom .posttags .custom_lines{display:block !important;height: '+blog_ext_height+'em !important;overflow: hidden !important;line-height:'+blog_ext_line_height+'em !important;}';
        }
        ...
        if (responsi_enable_fix_ext_tags_comment == 'none') {
            css += 'body .responsi-content-main .box-item .entry-item .entry-bottom .posttags .custom_lines{display:inherit !important;height: auto !important;overflow: hidden !important;line-height:'+blog_ext_line_height+'em !important;}';
        }
