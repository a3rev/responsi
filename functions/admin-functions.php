...
function responsi_build_dynamic_css( $preview = false ) {
    ...
    $dynamic_css .= 'a.button, a.button:visited, button:not(.customize-partial-edit-shortcut-button), .button, body #wrapper #content .button, body #wrapper #content .button:visited, body #wrapper #content .comment-entry div.reply a, body #wrapper #content #respond .form-submit input#submit, .custom_contact_popup input[type="submit"], input[type="submit"], input[type="button"],input[type="reset"] {'.$bt_css.'}';
