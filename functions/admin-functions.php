    ...
    if ( has_post_thumbnail( $id ) ) {
        ...
        if ( $attachments ){
            foreach ( $attachments as $attachment ) {
                if( 'image' === $type ){
                    $_thumbnail_image   = wp_get_attachment_image( $attachment->ID , $size, array( 'class' => $class, 'style' => $style, 'alt' => the_title_attribute( 'echo=0' ) ) ) ;
                }elseif( 'src' === $type ){
                    $_thumbnail_info    = wp_get_attachment_image_src( $attachment->ID, $size );
                    $_thumbnail_src     = $_thumbnail_info[0];
                }
            }
        }else{
...
function responsi_build_dynamic_css( $preview = false ) {
    ...
    $bt_css .= 'color:' . esc_attr( $button_text['color'] ) . ';';
    ...
    $dynamic_css .= 'a.button, a.button:visited, button, .button, body #wrapper #content .button, body #wrapper #content .button:visited, body #wrapper #content .comment-entry div.reply a, body #wrapper #content #respond .form-submit input#submit, .custom_contact_popup input[type="submit"], input[type="submit"], input[type="button"],input[type="reset"] {'.$bt_css.'}';
    $dynamic_css .= 'a.button, html body a.button{padding-top:' . $a_button_padding_top . 'px;padding-bottom:' . $a_button_padding_bottom . 'px;padding-left:' . $button_padding_left . 'px;padding-right:' . $button_padding_right . 'px;}';
    $dynamic_css .= 'body #wrapper #content .button:hover, body #wrapper #content .comment-entry div.reply a:hover, body #wrapper #content #respond .form-submit input#submit:hover,button:hover, .button:hover, body #wrapper #content .button:hover, body #wrapper #content .comment-entry div.reply a:hover, body #wrapper #content #respond .form-submit input#submit:hover, input[type="submit"]:hover, input[type="button"]:hover {color:' . esc_attr( $button_text['color'] ) . ' !important;text-decoration:none !important;}';
    ...
    $dynamic_css .= '#navigation ul.nav > li.current_page_item > a, #navigation ul.nav > li.current_page_parent > a, #navigation ul.nav > li.current-menu-ancestor > a, #navigation ul.nav > li.current-cat > a, #navigation ul.nav > li.current-menu-item > a { ' . responsi_generate_background_color($nav_currentitem_bg) . ' }';
    $dynamic_css .= '#navigation ul.nav > li.current_page_item > a, #navigation ul.nav > li.current_page_parent > a, #navigation ul.nav > li.current-menu-ancestor > a, #navigation ul.nav > li.current-cat > a, #navigation ul.nav > li.current-menu-item > a { color:' . $nav_currentitem . ' !important; }';
    $dynamic_css .= '#navigation ul.nav > li > a:hover,#navigation ul.nav > li:hover > a,#navigation .nav > li.menu-item-has-children:hover > a,.mobile-navigation .responsi-icon-menu:hover,.mobile-navigation .responsi-icon-cancel:hover,#navigation ul.nav > li.current_page_item > a:hover, #navigation ul.nav > li.current_page_parent > a:hover, #navigation ul.nav > li.current-menu-ancestor > a:hover, #navigation ul.nav > li.current-cat > a:hover, #navigation ul.nav > li.current-menu-item > a:hover{ color:' . $nav_hover . '!important; }';
