        ...
        <div id="single-page" <?php esc_attr(post_class()); ?>>
            <div class="responsi-area responsi-area-page single-ct">
                ...
                <div class="entry-content clearfix">
                    ...
                    <p><?php echo sprintf(esc_attr__('We\'re sorry, we can\'t find the page you are looking for. Perhaps you can return back to the <a href="%s" title="%s">homepage</a> or you can try finding it by using the search form below.', 'responsi'), esc_url(get_home_url()), esc_html(get_bloginfo('title')));?></p>
